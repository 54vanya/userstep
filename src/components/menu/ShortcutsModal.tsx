...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    rows: [
      ['Z Q S E C', 'Колонки ↙ ↖ ● ↗ ↘ (1P)'],
      ['Num1 Num7 Num5 Num9 Num3', 'Колонки ↙ ↖ ● ↗ ↘ (2P, double)'],
    ],
    note: 'Tap кладётся на ближайшую строку к текущему моменту (квантование по Split). Именно цифровой блок, не верхний ряд цифр. Медленный Rush повышает точность.',
  },
]
